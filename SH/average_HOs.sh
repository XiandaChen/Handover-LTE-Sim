...
time=75
	...
	COUNT=1
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "SUCCESSFUL_HANDOVER"   $TOTALNAME30  | awk '{print $1}'  > tmp
                ./compute_averageHO.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
	...
	COUNT=1
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "SUCCESSFUL_HANDOVER"   $TOTALNAME120  | awk '{print $1}'  > tmp
                ./compute_averageHO.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "SUCCESSFUL_HANDOVER"   $TOTALNAME200  | awk '{print $1}'  > tmp
                ./compute_averageHO.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "SUCCESSFUL_HANDOVER"   $TOTALNAME300  | awk '{print $1}'  > tmp
                ./compute_averageHO.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
