...
HOTYPE3=3       # Stands for the Proposed HO
	...
	COUNT=1
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "RX "$7   $TOTALNAME3  | grep "D" | awk '{print $14}'  > tmp
                ./compute_delay.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
                ./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> 3kmph_HOType1_delay_$8_$7.xlsx
                rm temporal
        let NBUE=NBUE+$3
        done
	...
	COUNT=1
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "RX "$7   $TOTALNAME30  | grep "D" | awk '{print $14}'  > tmp
                ./compute_delay.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
                ./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> 30kmph_HOType1_delay_$8_$7.xlsx
                rm temporal
        let NBUE=NBUE+$3
        done
	...
	COUNT=1
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "RX "$7   $TOTALNAME120  | grep "D" | awk '{print $14}'  > tmp
                ./compute_delay.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
                ./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> 120kmph_HOType1_delay_$8_$7.xlsx
                rm temporal
        let NBUE=NBUE+$3
        done
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "RX "$7   $TOTALNAME200  | grep "D" | awk '{print $14}'  > tmp
                ./compute_delay.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
                ./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> 200kmph_HOType1_delay_$8_$7.xlsx
                rm temporal
        let NBUE=NBUE+$3
        done
        ...
        until [ $NBUE -gt $2 ]; do
                ...
                grep "RX "$7   $TOTALNAME300  | grep "D" | awk '{print $14}'  > tmp
                ./compute_delay.sh tmp >> temporal
                rm tmp
                 let COUNT=COUNT+1
                done
                ./compute_average.sh temporal | awk '{print "'$NBUE' "$1}' >> 300kmph_HOType1_delay_$8_$7.xlsx
                rm temporal
        let NBUE=NBUE+$3
        done
...
#Average-Packet-Delay Users-per-Cell System-Packet-Delay[Sec]
