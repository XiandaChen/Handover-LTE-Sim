...
// added file, 20141223
// for Pico-eNB PHY, set TxPower of Pico to 30dBm
#include "penb-lte-phy.h"
 ...
 *  - noise figure = 5		// added, 20150108, original is 2.5
 *  - n0 = -174 dBm
 *  - sub channel bandwidth = 180 kHz
 *
 *  noise_db = noise figure + n0 + 10log10 (180000) - 30 = -146.45		// added, 20150108, original is 148.95
 */
#define NOISE -146.45		// added, 20150108, original is 148.95
#define UL_INTERFERENCE 4

PenbLtePhy::PenbLtePhy()
{
  SetDevice(NULL);
  SetDlChannel(NULL);
  SetUlChannel(NULL);
  ...
  SetTxPower(30); //added, 20150108, in dBm
}
...
void
PenbLtePhy::DoSetBandwidthManager (void)
{
...
void
PenbLtePhy::StartTx (PacketBurst* p)
{
...
void
PenbLtePhy::StartRx (PacketBurst* p, TransmittedSignal* txSignal)
{
...
void
PenbLtePhy::SendIdealControlMessage (IdealControlMessage *msg)
{
...
void
PenbLtePhy::ReceiveIdealControlMessage (IdealControlMessage *msg)
{
...
void
PenbLtePhy::ReceiveReferenceSymbols (NetworkNode* n, TransmittedSignal* s)
{
