 ...
 *  - noise figure = 9		// added, 20150108, original is 2.5
 *  - n0 = -174 dBm
 *  - sub channel bandwidth = 180 kHz
 *
 *  noise_db = noise figure + n0 + 10log10 (180000) - 30 = -142.45		// added, 20150108, original is 148.95
 */
#define NOISE -142.45		// added, 20150108, original is 148.95
...
UeLtePhy::UeLtePhy()
{
  ...
  SetTxPower (23); //added, 20150108, in dBm
