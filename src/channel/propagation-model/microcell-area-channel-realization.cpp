...
MicroCellAreaChannelRealization::MicroCellAreaChannelRealization(NetworkNode* src, NetworkNode* dst)
{
  ...
  std::cout << "Created Channel Realization between "
...
MicroCellAreaChannelRealization::GetPathLoss (void)
{
   ...
   * L = 24 + 45log10(R+20)   * R, in kilometers, is the distance between two nodes
   */
  double distance;
  ...
  // added, 20141223
  // the original is m_pathLoss = 24 + (45 * log10 (distance));
  m_pathLoss = 24 + (45 * log10 ((distance+20) * 0.001));
