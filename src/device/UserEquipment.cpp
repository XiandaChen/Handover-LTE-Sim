							  ...
							  Mobility::MobilityModel model)
{
  ...
  // added, 20141230
  m_previousProbableNewTargetNode = target;
  ...
  // added, 20150102
  m_previouseAbsolutePosition = position;

  // added, 20140107, RSRP_measurement_period = 10 ms
  // original is 0.001 (1 ms)
  m_timePositionUpdate = 0.01;
